<template>
  <div
    @click.alt="changeView"
    @click.shift="changeView"
    @click.meta="focusView"
  >
...
module.exports = {
  ...
  methods: {
    ...
    setTaskLine: function(params) {
      var cursor_task = params.children.filter(function(task) {
